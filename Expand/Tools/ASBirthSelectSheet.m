...
- (void)makeUI {
    ...
    _titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, 10, MainScreenWidth - 20, 30)];
    _titleLabel.textColor = kAppColorAuxiliaryGreen;
    _titleLabel.text = Localized(@"您的出生日期");
    _titleLabel.textAlignment = NSTextAlignmentCenter;
    _titleLabel.font = [UIFont systemFontOfSize:20];
    [_containerView addSubview:_titleLabel];
    
    _datePicker =  [[UIDatePicker alloc] initWithFrame:CGRectMake(0, 50, MainScreenWidth - 20, 160)];
