...
- (void)serviceTypeAction:(UIButton *)btn{
    [SVProgressHUD showErrorWithStatus:@"serviceTypeAction"];
}

- (void)serviceTimeAction:(UIButton *)btn{
    [SVProgressHUD showErrorWithStatus:@"serviceTimeAction"];
}
...
- (UIButton *)serviceTypeBtn{
    if (!_serviceTypeBtn) {
        ...
        [_serviceTypeBtn setImage:PNGIMAGE(@"cbb_service-type") forState:(UIControlStateNormal)];
