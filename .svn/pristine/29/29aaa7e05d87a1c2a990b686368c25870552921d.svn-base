...
- (void)awakeFromNib {
    ...
    layout.itemSize = CGSizeMake(self.myCollection.frame.size.width / 3 - 10 * kWidthFactor , self.myCollection.frame.size.height  - 40 * kHeightFactor);
    layout.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    layout.minimumLineSpacing = 10 * kWidthFactor;
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (indexPath.item < self.images.count) {
        ...
        img = [UIImage imageNamed:@"send_image"];
